...
public void admin_clicks_user_on_the_navigation_bar_UM() {
...
public void admin_should_see_a_alert_open_with_heading_along_with_and_button_for_deletion_UM(String expectedconText,String expYes,String expNo) {
	...
	Assert.assertTrue(deleteUserSD.deleletePopUpOptionNo().isDisplayed(), "Delete popoup does not have no button displayed");
	Assert.assertTrue(deleteUserSD.deleletePopUpOptionYes().isDisplayed(), "Delete popoup does not have yes button displayed");
...
public void admin_is_on_deletion_alert_UM(String expectedDelPopUp) {
...
public void admin_is_on_deletion_alert_UM_after_clicking_delete_icon(String expectedDelPopUp) {
	deleteUserSD.clickUserModule();
	deleteUserSD.ClickRightDelBtn();
	Assert.assertTrue(deleteUserSD.Deletealert().isDisplayed(), "Delete popoup is not displayed");
	String actualText=deleteUserSD.getConfirmText();
