...
public class UserPageV2 {
	...
	@FindBy(xpath="//i[contains(@class,'p-sortable-column-icon')]")WebElement userIdArrow;
	...
	@FindBy(xpath = "//div[@class='p-datatable-wrapper ng-star-inserted']//table[@role='grid']")
  ...
  public boolean commonDeleteBtn() {
	  return commonDeleteBttn.isEnabled();
	    ...
	    public void clickAnyCheckBox() {
	        // Find all checkbox elements in the data table
	

	        // Click the first checkbox found, if any
	        try {
